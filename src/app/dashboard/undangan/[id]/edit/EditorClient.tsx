...
export default function EditorClient({ initialData }: EditorClientProps) {
    ...
    const LOCKED_TABS = ["mempelai", "fotocover"];        // tidak bisa reorder DAN tidak bisa toggle
    const NO_REORDER_TABS = ["mempelai", "fotocover", "musik"]; // tidak bisa reorder, tapi bisa toggle
