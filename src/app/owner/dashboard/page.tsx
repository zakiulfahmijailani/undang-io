...
export default function OwnerDashboardPage() {
    ...
    const revenueData = [
        ...
        { month: 'Nov', revenue: 15500000 },
        { month: 'Des', revenue: 18200000 },
        { month: 'Jan', revenue: 22000000 },
        { month: 'Feb', revenue: 19800000 },
        { month: 'Mar', revenue: 28500000 },
    ];

    const packageDistributionData = [
        { name: 'Gratis', value: 65, fill: '#94a3b8' },
        { name: 'Premium', value: 25, fill: '#10B981' },
        { name: 'Eksklusif', value: 10, fill: '#8b5cf6' },
    ];

    // Dummy Transactions
    const recentTransactions = [
        { id: "TRX-001", user: "Budi Santoso", pkg: "Eksklusif", amount: 249000, status: "Sukses", date: "12 Mar, 14:30" },
        { id: "TRX-002", user: "Andi Wijaya", pkg: "Premium", amount: 99000, status: "Sukses", date: "12 Mar, 11:15" },
        { id: "TRX-003", user: "Siti Amelia", pkg: "Premium", amount: 99000, status: "Pending", date: "11 Mar, 19:40" },
        { id: "TRX-004", user: "Reza Rahadian", pkg: "Eksklusif", amount: 249000, status: "Sukses", date: "11 Mar, 16:05" },
        { id: "TRX-005", user: "Dina Mariana", pkg: "Premium", amount: 99000, status: "Gagal", date: "11 Mar, 10:22" },
        { id: "TRX-006", user: "Eko Patrio", pkg: "Eksklusif", amount: 249000, status: "Sukses", date: "10 Mar, 09:10" },
        { id: "TRX-007", user: "Ayu Ting Ting", pkg: "Premium", amount: 99000, status: "Sukses", date: "09 Mar, 21:45" },
        { id: "TRX-008", user: "Raffi Ahmad", pkg: "Eksklusif", amount: 249000, status: "Sukses", date: "09 Mar, 15:30" },
        { id: "TRX-009", user: "Nagita Slavina", pkg: "Premium", amount: 99000, status: "Sukses", date: "08 Mar, 12:00" },
        { id: "TRX-010", user: "Deddy Corbuzier", pkg: "Eksklusif", amount: 249000, status: "Sukses", date: "07 Mar, 08:30" },
    ];
        ...
        <div className="flex flex-col gap-8 max-w-7xl mx-auto pb-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                ...
                <Card className="border-emerald-200 shadow-sm bg-emerald-50/30">
                    ...
                    <CardContent>
                        <div className="text-3xl font-bold text-emerald-700">Rp 28.5M</div>
                        <p className="text-xs text-emerald-600 mt-1 flex items-center gap-1">
                        ...
                        <table className="w-full text-left text-sm">
                            <thead className="bg-gray-50 text-gray-500 font-medium border-b border-gray-100">
                                <tr>
                                    ...
                                    <th className="py-3 px-6">Paket Dibeli</th>
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {recentTransactions.map((tx) => (
                                    <tr key={tx.id} className="hover:bg-gray-50/50 transition-colors">
                                        <td className="py-4 px-6 font-mono text-xs text-gray-500">{tx.id}</td>
