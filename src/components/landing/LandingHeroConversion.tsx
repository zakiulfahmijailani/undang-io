...
export function LandingHeroConversion({ themes }: LandingHeroConversionProps) {
  ...
  return (
    <section className="relative overflow-hidden border-b border-landing-border bg-landing-paper">
      ...
      <div className="relative mx-auto grid min-h-[calc(100dvh-4rem)] max-w-7xl items-center gap-10 px-4 py-6 sm:px-6 sm:py-12 lg:grid-cols-[1.04fr_0.96fr] lg:gap-14 lg:px-10 lg:py-12">
        ...
        <div className="relative flex items-center justify-center py-4 lg:min-h-[720px]">
          ...
          <LiveInvitationPreview groomName={groomName} brideName={brideName} selectedThemeKey={selectedThemeKey} />
        </div>
      </div>
    </section>
  );
